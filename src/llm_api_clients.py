...
class LLMClientFactory:
    ...
    def create_client(provider: str, api_key: str, model_name: Optional[str] = None, **kwargs) -> BaseLLMClient:
        ...
        if provider.lower() == "openai":
            ...
            endpoint_url = kwargs.get("endpoint_url", "https://api.deepseek.com/v1/chat/completions")
            ...
            endpoint_url = kwargs.get("endpoint_url", "https://api.moonshot.cn/v1/chat/completions")
